            ...
            <div className="container">
                <div className={styles.PBSKidsContainer}>
                    ...
                    <div className={clsx(styles.description)}>
                        ...
                        PBS KIDS collaborates with children’s media producers, game development studios, and curriculum and accessibility advisors. PBS KIDS has built a framework that is stable, scalable, high-performance, and modern.
                            </p></div>
